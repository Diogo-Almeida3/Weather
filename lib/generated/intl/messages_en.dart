...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(humidity) => "Humidity: ${humidity}%";

  static String m7(humidity_percentage) => "${humidity_percentage}%";

  static String m8(uv) => "Ind. UV: ${uv} ";

  static String m9(last_Updated) => "Last Updated on ${last_Updated}";

  static String m10(lat, lon) => "${lat}, ${lon}";

  static String m11(max_temp, min_temp) => "${max_temp}℃ / ${min_temp}℃";

  static String m12(max_temperature) => "Maximum: ${max_temperature}℃ ";

  static String m13(medium_temperature) => "Medium: ${medium_temperature}℃";

  static String m14(min_temperature) => "Minimum: ${min_temperature}℃";

  static String m15(name, region) => "${name},${region}";

  static String m16(prob_rain) => "Prob. Rain: ${prob_rain}%";

  static String m17(prob_snow) => "Prob. Snow: ${prob_snow}%";
